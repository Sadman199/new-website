    ...
    'navigation' => [
        ...
        [
            ...
            'items' => [
                ...
                ['route' => 'admin.panel.pages.index', 'icon' => 'fas fa-file-alt', 'label' => 'Static Pages'],
                ['route' => 'admin.panel.media.index', 'icon' => 'fas fa-photo-video', 'label' => 'Videos & Photos'],
        ...
        [
            ...
            'items' => [
                ...
                ['route' => 'admin.panel.subscribers.index', 'icon' => 'fas fa-envelope', 'label' => 'Subscribers'],
        ...
        [
            ...
            'items' => [
                ...
                ['route' => 'admin.panel.languages.index', 'icon' => 'fas fa-language', 'label' => 'Languages'],
                ['route' => 'admin.panel.social-items.index', 'icon' => 'fas fa-share-alt', 'label' => 'Social Links'],
            ],
        ],
    ],
