  ...
  <div class="max-w-6xl mx-auto">
    <div class="flex flex-col items-center text-center">
      ...
      <div class="inline-flex items-center gap-3 bg-gradient-to-r from-amber-400 to-amber-600 text-amber-900 px-6 py-2 rounded-full shadow-lg mb-8">
        ...
        <div class="font-bold tracking-wide text-white">Best Brokers {{ date('Y') }}</div>
      </div>
      
      <h1 class="text-3.5xl md:text-5xl font-bold text-white mb-5 max-w-2.5xl leading-snug">
          Awards {{ date('Y') }}: <span class="bg-gradient-to-r from-yellow-400 to-yellow-500 bg-clip-text text-transparent">
     ...
     <p class="font-semibold text-gray-300 mb-12 max-w-2xl leading-relaxed">
          Discover the top performers in the forex industry for {{ date('Y') }}. Our prestigious awards recognize excellence, innovation, and outstanding service in forex brokerage.
      </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-20">
            <div class="inline-flex items-center gap-3 text-slate-600 mb-6">
                ...
                <span class="text-sm font-medium tracking-wider uppercase">Methodology {{ date('Y') }}</span>
                <div class="w-2 h-2 bg-yellow-500 rounded-full"></div>
            </div>
