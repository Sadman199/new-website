  ...
  <div class="relative container mx-auto px-6 z-10">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <div class="flex justify-center items-center mb-6">
        <i class="fas fa-shield-alt text-3xl text-yellow-400 mr-3"></i>
        <h1 class="text-2xl md:text-4xl font-extrabold text-white drop-shadow-lg">
          Brokers Regulated by <span class="text-yellow-400">{{ $regulator }}</span>
        </h1>
      </div>

      <!-- Subtitle -->
      <p class="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
        Explore trusted forex brokers operating under the supervision of {{ $regulator }}.
      </p>
...
<section id="broker-list">
  <div class="container max-w-7xl mx-auto mb-12">
    ...
    @else
        <x-no-brokers-found message="No brokers found regulated by {{ $regulator }}." />
    @endif
