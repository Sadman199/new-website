  ...
  <div class="relative container mx-auto px-6 z-10">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <div class="flex justify-center items-center mb-6">
        <i class="fas fa-laptop-code text-3xl text-yellow-400 mr-3"></i>
        <h1 class="text-2xl md:text-4xl font-extrabold text-white drop-shadow-lg">
          Brokers Supporting <span class="text-yellow-400">{{ $platform }}</span>
        </h1>
      </div>

      <!-- Subtitle -->
      <p class="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
        Find top forex brokers that offer {{ $platform }} for your trading strategy.
      </p>
  ...
  <div class="container max-w-7xl mx-auto">
    <div>
        @if ($brokers->count() > 0)
            ...
            <!-- Pagination -->
            @if ($brokers->hasPages())
                <div class="mt-8 flex items-center justify-center space-x-1 mb-8">
                    {{-- Previous Page Link --}}
