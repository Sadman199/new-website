        ...
        <div class="bg-gradient-to-r from-gray-950 to-gray-700 py-4 px-6 border-b border-gray-800">
            <div class="flex items-center justify-between flex-wrap gap-4">
              ...
              @php
                    ...
                    $isRegulated = $firstAccount && $firstAccount->is_regulated;
                    ...
                    <div class="flex flex-col sm:flex-row items-start gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
                                ...
                                <div class="text-center p-3 bg-gray-800/50 rounded-lg border border-gray-400">
                                    <div class="text-sm font-bold text-gray-100">
                                       {{ trim(html_entity_decode(strip_tags(optional($broker->accountOptions->first())->trading_instruments))) ?? '—' }}
                                    </div>
                                    <div class="text-xs text-gray-100">Instruments</div>
                                </div>
                            </div>
