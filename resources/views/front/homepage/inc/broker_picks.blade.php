        ...
        <header class="bc-picks-section__head">
            <div class="bc-picks-section__intro">
                <p class="bc-picks-section__eyebrow">
                    ...
                    Editor's choice · {{ date('F Y') }}
                </p>
                <h2 id="bcPicksTitle" class="bc-picks-section__title">Top broker picks</h2>
                <p class="bc-picks-section__sub">Hand-picked from live ratings, spreads, and account data — switch categories to find your ideal match.</p>
            </div>
