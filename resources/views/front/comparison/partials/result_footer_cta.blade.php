<section class="bc-result-cta" aria-label="Next steps">
    <div class="bc-result-cta__inner">
        <div class="bc-result-cta__copy">
            ...
            <p class="bc-result-cta__sub">Read our in-depth reviews, compare more brokers, or run a safety check before you open an account.</p>
        </div>
        <div class="bc-result-cta__actions">
            <a href="{{ route('broker.comparison') }}" class="bc-compare-btn bc-compare-btn--ghost">Compare other brokers</a>
