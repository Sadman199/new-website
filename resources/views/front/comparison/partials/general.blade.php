            ...
            <div class="space-y-4">
                <div>
                   ...
                   <p class="text-sm text-gray-800 mt-1">
                        {{ implode(', ', is_array($r = json_decode(strip_tags($broker1->regulation), true)) ? $r : [strip_tags($broker1->regulation ?? 'Not specified')]) }}
                    </p>
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="space-y-4">
                <div>
                    <p class="text-xs text-gray-400">Regulation</p>
                    <p class="text-sm text-gray-800 mt-1">
                        {{ implode(', ', is_array($r = json_decode(strip_tags($broker2->regulation), true)) ? $r : [strip_tags($broker2->regulation ?? 'Not specified')]) }}
                    </p>
                 </div>
                <div>
                    <p class="text-xs text-gray-400">Founded</p>
