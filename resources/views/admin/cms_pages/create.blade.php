...
@section('heading', 'Create CMS Page')
...
<div class="section-body">
    <form action="{{ route('admin_cms_pages_store') }}" method="POST" id="cms-page-form">
        @csrf
...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/cms-page-builder.css') }}?v=2">
@endpush
