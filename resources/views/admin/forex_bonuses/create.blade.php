                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="0.01" min="0" name="max_credit" id="max_credit" class="form-control" value="{{ old('max_credit') }}" placeholder="e.g. 500">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="wagering_requirement">Wagering Requirement</label>
                                        <input type="text" name="wagering_requirement" id="wagering_requirement" class="form-control" value="{{ old('wagering_requirement') }}" placeholder="e.g. 30x bonus">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="volume_requirement">Volume Requirement</label>
                                        <input type="text" name="volume_requirement" id="volume_requirement" class="form-control" value="{{ old('volume_requirement') }}" placeholder="e.g. 10 standard lots">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="eligible_clients" id="eligible_clients" class="form-control">
                                            ...
                                            <option value="new" @selected(old('eligible_clients') === 'new')>New clients</option>
                                            <option value="existing" @selected(old('eligible_clients') === 'existing')>Existing clients</option>
                                            <option value="both" @selected(old('eligible_clients') === 'both')>New and existing clients</option>
                                        </select>
                                    </div>
