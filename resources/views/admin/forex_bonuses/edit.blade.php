                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="broker_id" id="broker_id" class="form-control">
                                            ...
                                            @foreach($brokers as $broker)
                                                <option value="{{ $broker->id }}" @selected(old('broker_id', $forexBonus->broker_id) == $broker->id)>{{ $broker->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <!-- Publish Date -->
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" name="publish_date" id="publish_date" class="form-control" value="{{ old('publish_date', $forexBonus->publish_date?->format('Y-m-d')) }}" required>
                                    </div>
                                    <!-- Display Author -->
                                    <div class="col-md-6 mb-3">
                                        <label for="author_name">Display Author Label</label>
                                        <input type="text" name="author_name" id="author_name" class="form-control" value="{{ old('author_name', $forexBonus->author_name) }}" placeholder="Optional — auto-filled from Written credit">
                                    </div>
                                    <!-- Promo Type -->
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        @include('admin.partials._image_upload_preview', [
                                            ...
                                            'label' => 'Feature Image',
                                            'currentUrl' => $forexBonus->feature_image ? asset($forexBonus->feature_image) : null,
                                        ])
                                    </div>
                                </div>

                                @include('admin.partials._editorial_fields', ['model' => $forexBonus, 'editorialOptions' => $editorialOptions])
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="0.01" name="min_deposit" id="min_deposit" class="form-control" value="{{ old('min_deposit', $forexBonus->min_deposit) }}">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="bonus_amount">Bonus Amount ($)</label>
                                        <input type="number" step="0.01" name="bonus_amount" id="bonus_amount" class="form-control" value="{{ old('bonus_amount', $forexBonus->bonus_amount) }}">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3 d-flex align-items-end">
                                        <div class="custom-control custom-checkbox mb-2">
                                            <input type="checkbox" class="custom-control-input" id="is_featured" name="is_featured" value="1" @checked(old('is_featured', $forexBonus->is_featured))>
