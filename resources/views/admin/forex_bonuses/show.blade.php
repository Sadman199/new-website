                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br><small class="text-muted">{{ $forexBonus->publish_date?->format('d M Y') }}</small>
                            ...
                            <td>
                                @if($forexBonus->broker)
                                    <a href="{{ route('admin_broker_edit', $forexBonus->broker_id) }}">{{ $forexBonus->broker->name }}</a>
                                @else
                                    <span class="text-muted">—</span>
                                @endif
                            </td>
                            <td>{{ $forexBonus->displayAuthorName() }}</td>
                            <td>
