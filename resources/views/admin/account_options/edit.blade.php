...
@section('heading', 'Edit Account Option')
    ...
    <div class="ab-wrap">
        <header class="ab-header">
            <div class="ab-identity">
                ...
                <div>
                    <p class="ab-header__eyebrow">Edit account option</p>
                    <h1 class="ab-header__title">{{ $accountOption->account_type }}</h1>
                    <p class="ab-header__sub">{{ $broker->name }} @if($accountOption->slug) · {{ $accountOption->slug }} @endif</p>
                </div>
            </div>
