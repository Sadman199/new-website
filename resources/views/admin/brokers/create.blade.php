    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin_broker_store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rating" id="rating" class="form-control" step="0.01" min="0" max="5" value="{{ old('rating') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="mt-2" id="logo-preview-container" style="display: none;">
                                                <img id="logo-preview" src="" alt="Logo Preview" class="img-fluid" style="max-width: 200px; max-height: 200px;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="banner_image_1" id="banner_image_1" class="form-control-file" accept="image/*">
                                            @error('banner_image_1')<small class="text-danger">{{ $message }}</small>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="banner_image_2">Banner Image 2</label>
                                            <input type="file" name="banner_image_2" id="banner_image_2" class="form-control-file" accept="image/*">
                                            @error('banner_image_2')<small class="text-danger">{{ $message }}</small>@enderror
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="visit_site" id="visit_site" class="form-control" value="{{ old('visit_site') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="open_live" id="open_live" class="form-control" value="{{ old('open_live') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="open_demo" id="open_demo" class="form-control" value="{{ old('open_demo') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="short_description" id="short_description" class="form-control snote" rows="4">{{ old('short_description') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="pros" id="pros" class="form-control snote" rows="4">{{ old('pros') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="cons" id="cons" class="form-control snote" rows="4">{{ old('cons') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="minimum_deposit" id="minimum_deposit" class="form-control" value="{{ old('minimum_deposit') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mobile_trading" id="mobile_trading" class="form-control" value="{{ old('mobile_trading') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="social_trading" id="social_trading" class="form-control" value="{{ old('social_trading') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="web_trader" id="web_trader" class="form-control" value="{{ old('web_trader') }}">
                                        ...
                                        <div class="form-group">
                                            @foreach ([
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" name="platforms[]" id="{{ $id }}" value="{{ $platform }}" class="form-check-input" {{ in_array($platform, old('platforms', [])) ? 'checked' : '' }}>
                                   ...
                                   <div class="col-md-4">
                                            ...
                                            @foreach ([
                                                ...
                                                <div class="form-check">
                                                    <input 
                                                        ...
                                                        {{ in_array($regulation, old('regulation', $broker->regulation ?? [])) ? 'checked' : '' }}
                                                    >
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="regulated_jurisdictions" id="regulated_jurisdictions" class="form-control snote" rows="4">{{ old('regulated_jurisdictions') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="regulatory_licenses" id="regulatory_licenses" class="form-control snote" rows="4">{{ old('regulatory_licenses') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="deposit_methods" id="deposit_methods" class="form-control snote" rows="4">{{ old('deposit_methods') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="withdrawal_method" id="withdrawal_method" class="form-control snote" rows="4">{{ old('withdrawal_method') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="payment_methods" id="payment_methods" class="form-control snote" rows="4">{{ old('payment_methods') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="capitalization" id="capitalization" class="form-control snote" rows="4">{{ old('capitalization') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="insurance" id="insurance" class="form-control snote" rows="4">{{ old('insurance') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="languages" id="languages" class="form-control snote" rows="4">{{ old('languages') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="pricing" id="pricing" class="form-control snote" rows="4">{{ old('pricing') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="customer_support" id="customer_support" class="form-control snote" rows="4">{{ old('customer_support') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="educational_resources" id="educational_resources" class="form-control snote" rows="4">{{ old('educational_resources') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="research_tools" id="research_tools" class="form-control snote" rows="4">{{ old('research_tools') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="charting_tools" id="charting_tools" class="form-control snote" rows="4">{{ old('charting_tools') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="news_and_analysis" id="news_and_analysis" class="form-control snote" rows="4">{{ old('news_and_analysis') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @php
                                                // Broker Categories (replaced as requested)
                                                $accountTypes = [
                                                ...
                                                $selected = old('account_types', []);

                                                if (isset($broker) && $broker->account_types) {
                                                    $decoded = json_decode($broker->account_types, true);
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @php
                                                ...
                                                if (isset($broker) && $broker->associated_countries) {
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input type="checkbox" name="featured_broker" id="featured_broker" class="form-check-input" value="1" {{ old('featured_broker', $broker->featured_broker ?? 0) == 1 ? 'checked' : '' }}>
                ...
                <!-- Submit Button -->
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary btn-lg">Save Broker</button>
                </div>
            </form>
        </div>
    </div>
