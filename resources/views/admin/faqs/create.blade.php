...
<div class="ab-page ab-page--hub">
    <div class="ab-wrap">
        <header class="ab-header">
            <div>
                <p class="ab-header__eyebrow">FAQ Section</p>
                <h1 class="ab-header__title">Add FAQ</h1>
                <p class="ab-header__sub">Write a question and answer, then attach it to a broker.</p>
            </div>
        ...
        <form action="{{ route('admin_faq_store') }}" method="POST" novalidate>
            @csrf
