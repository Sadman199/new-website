                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $post_single->slug) }}" required>
                        </div>
                        <div class="form-group mb-3">
                            <label>Post Detail *</label>
                            <textarea name="post_detail" class="form-control snote" cols="30"
                                rows="10">{{ $post_single->post_detail }}</textarea>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="sub_category_id" class="form-control select2">
                                ...
                                <option value="{{ $item->id }}" @if($item->id == $post_single->sub_category_id) selected
                                    @endif>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>{{ $item->tag_name }}</td>
                                    <td>
                                        <a href="{{ route('admin_post_delete_tag', [$item->id,$post_single->id]) }}"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="language_id" class="form-control">
                                ...
                                <option value="{{ $row->id }}" @if($row->id == $post_single->language_id) selected
