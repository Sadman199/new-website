@php $isEdit = $program->exists; @endphp
<div class="ab-form">
    <section class="ab-section" id="content">
        <div class="ab-section__head"><h2>Program</h2><p>Account size, fees, drawdown, and trading rules.</p></div>
        <div class="ab-section__body">
            <div class="form-group">
                ...
                @error('prop_firm_id')<small class="ab-error">{{ $message }}</small>@enderror
            </div>
            <div class="row">
                <div class="col-md-6 form-group"><label for="name">Program Name <span class="text-danger">*</span></label><input type="text" name="name" id="name" class="form-control" required value="{{ old('name', $program->name) }}"></div>
            ...
            <div class="form-group mb-0">
                <div class="custom-control custom-checkbox">
                    ...
                    <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" @checked(old('is_active', $program->is_active ?? true))>
...
<div class="ab-save">
    <button type="submit" class="ab-btn ab-btn--primary"><i class="fas fa-save" aria-hidden="true"></i> {{ $isEdit ? 'Save program' : 'Create program' }}</button>
    <a href="{{ route('admin_prop_firm_programs_show') }}" class="ab-btn ab-btn--ghost">Cancel</a>
</div>
