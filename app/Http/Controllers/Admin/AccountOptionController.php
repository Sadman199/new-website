...
class AccountOptionController extends Controller
{
   ...
   public function store(Request $request, $broker_id)
   {
       $request->validate([
        ...
        'max_leverage' => 'required|numeric|min:1|max:10000',
        ...
        'min_trade_size' => 'required|numeric|min:0.01|max:1000', 
        'max_trade_size' => 'required|numeric|min:0.01|max:10000',
        'margin_call_level' => 'nullable|numeric',
        'stop_out_level' => 'required|numeric',
        'max_open_positions' => 'required|integer',
   ...
   public function update(Request $request, $broker_id, $id)
   {
       $request->validate([
        ...
        'is_demo_available' => 'nullable|boolean',
        'swap_free' => 'nullable|boolean',
        'min_trade_size' => 'required|numeric|min:0.01|max:1000', // Adjust max value as needed
        'max_trade_size' => 'required|numeric|min:0.01|max:10000',
        'margin_call_level' => 'nullable|numeric',
        'stop_out_level' => 'required|numeric',
        'max_open_positions' => 'required|integer',
