...
class FooterIndexService
{
    ...
    private function brand(): array
    {
        return [
            'name' => 'BrokersCourt',
            'tagline' => 'Independent broker reviews, comparisons, and trading education — researched by our editorial team.',
            'logo' => 'https://www.brokerscourt.com/uploads/logo.png',
        ];
    }
    ...
    private function forUsers(): array
    {
        return [
            ...
            ['label' => 'Bonuses', 'url' => route('forex_deposit_bonus')],
